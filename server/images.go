...
func CopyModel(src, dst model.Name) error {
	...
	if err := os.MkdirAll(filepath.Dir(dstpath), envconfig.ModelDirectoryPermissions()); err != nil {
		return err
	}
...
func PullModel(ctx context.Context, name string, regOpts *registryOptions, fn func(api.ProgressResponse)) error {
	...
	if err := os.MkdirAll(filepath.Dir(fp), envconfig.ModelDirectoryPermissions()); err != nil {
		return err
	}

	err = os.WriteFile(fp, manifestJSON, envconfig.ModelFilePermissions())
	if err != nil {
